...
exports.calculateTianDe = calculateTianDe;
exports.calculateYueDe = calculateYueDe;
exports.calculateTianXi = calculateTianXi;
exports.calculateHongLuan = calculateHongLuan;
exports.calculateShaGong = calculateShaGong;
exports.calculateWuGui = calculateWuGui;
exports.calculateSiFu = calculateSiFu;
exports.calculateSuiPo = calculateSuiPo;
exports.calculateBaiHu = calculateBaiHu;
exports.calculateJinShenQiSha = calculateJinShenQiSha;
exports.calculateZhuQue = calculateZhuQue;
exports.calculateAllAuspiciousGods = calculateAllAuspiciousGods;
exports.calculateAllInauspiciousEvils = calculateAllInauspiciousEvils;
exports.getSeason = getSeason;
exports.getEvilResolutionMethods = getEvilResolutionMethods;
exports.getEvilLevel = getEvilLevel;
exports.getGodLevel = getGodLevel;
// 天干地支對應表
const HEAVENLY_STEMS = ['甲', '乙', '丙', '丁', '戊', '己', '庚', '辛', '壬', '癸'];
const EARTHLY_BRANCHES = ['子', '丑', '寅', '卯', '辰', '巳', '午', '未', '申', '酉', '戌', '亥'];
// 月份對應的天德貴人
const TIAN_DE_MONTHLY = {
    1: '丁', // 正月天德在丁
    2: '申', // 二月天德在申
    3: '壬', // 三月天德在壬
    4: '辛', // 四月天德在辛
...
// 年支對應的紅鸞位置
const HONG_LUAN_YEARLY = {
    '子': '卯', '丑': '寅', '寅': '丑', '卯': '子',
    '辰': '亥', '巳': '戌', '午': '酉', '未': '申',
    '申': '未', '酉': '午', '戌': '巳', '亥': '辰'
};
// 季節對應的死符位置
const SI_FU_SEASONAL = {
    '春': '未', // 春季死符在未
    '夏': '戌', // 夏季死符在戌
    '秋': '丑', // 秋季死符在丑
    '冬': '辰' // 冬季死符在辰
 ...
 * 計算天德貴人
 */
function calculateTianDe(ganZhi, lunarDate) {
 ...
 * 計算月德貴人
 */
function calculateYueDe(ganZhi, lunarDate) {
 ...
 * 計算天喜星
 */
function calculateTianXi(ganZhi) {
 ...
 * 計算紅鸞星
 */
function calculateHongLuan(ganZhi) {
 ...
 * 計算三吉星 - 煞貢星
 */
function calculateShaGong(ganZhi, lunarDate) {
    // 煞貢星的計算規則（簡化版）
    const shaGongMonthly = {
 ...
 * 計算五鬼煞
 */
function calculateWuGui(ganZhi) {
 ...
 * 計算死符煞
 */
function calculateSiFu(ganZhi, season) {
 ...
 * 計算歲破煞
 */
function calculateSuiPo(ganZhi) {
    const yearZhi = ganZhi.year.charAt(1);
    // 歲破對沖表
    const suiPoMap = {
        '子': '午', '丑': '未', '寅': '申', '卯': '酉',
 ...
 * 計算白虎煞
 */
function calculateBaiHu(ganZhi) {
    // 白虎煞的計算（簡化版）
 ...
 * 計算金神七煞
 */
function calculateJinShenQiSha(ganZhi) {
 ...
 * 計算朱雀煞
 */
function calculateZhuQue(ganZhi) {
 ...
 * 綜合計算所有吉神
 */
function calculateAllAuspiciousGods(ganZhi, lunarDate) {
    const gods = [];
    // 計算各種吉神
 ...
 * 綜合計算所有凶煞
 */
function calculateAllInauspiciousEvils(ganZhi, lunarDate, season = '冬') {
    const evils = [];
    // 計算各種凶煞
 ...
 * 神煞化解機制
 */
function getEvilResolutionMethods(evil) {
    const resolutions = {
...
//# sourceMappingURL=gods-evils-rules.js.map