...
const DongGongCalculator_1 = require("./services/DongGongCalculator");
const dong_gong_activities_1 = require("./data/dong-gong-activities");
const calculator = new DongGongCalculator_1.DongGongCalculator();
// 測試日期：2025年1月15日
const testDate = new Date(2025, 0, 15);
// 測試活動：嫁娶
const activity = (0, dong_gong_activities_1.getActivityById)('marry');
// 測試生辰八字
const birthInfo = {
    year: 1990,
    month: 8,
...
try {
    ...
    // 找出最佳時辰
    const bestHour = sevenStepProcess.step6_hourSelection.reduce((best, current) => current.suitability > best.suitability ? current : best);
...
//# sourceMappingURL=dong-gong-example.js.map