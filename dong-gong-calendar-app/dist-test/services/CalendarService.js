...
class CalendarService {
    ...
    generateDayInfo(date) {
        ...
        // 獲取嫁娶活動定義
        const marriageActivity = { id: 'marry', name: '嫁娶', category: '人事' };
        // 執行董公擇日分析
        ...
        // 確定色彩代碼
        const colorCode = this.determineColorCode(analysis.step7_comprehensiveJudgment.level, isHuangDao, isHeiDao, specialDays);
        return {
            gregorianDate: date,
